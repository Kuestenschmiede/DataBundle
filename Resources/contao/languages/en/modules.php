...
$GLOBALS['TL_LANG']['FMD']['public_noneditable'] = ['(data) Listing without write access', 'List of elements without write access'];
$GLOBALS['TL_LANG']['FMD']['member_editable'] = ['(data) Listing with write access for members', 'List of elements with write access'];