...
$GLOBALS['TL_DCA']['tl_c4g_maps']['palettes']['mpCntnt'] = "{general_legend},name,location_type;{location_legend},tDontShowIfEmpty,data_layername,typeSelection,data_hidelayer,hide_when_in_tab,hideInStarboard".$routing.";{protection_legend:hide},protect_element;{expert_legend:hide},excludeFromSingleLayer,be_optimize_checkboxes_limit;";
